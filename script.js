            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(() => {
                        ...
                        successMsg.style.cssText = 'color: #28a745; margin-top: 1rem; font-weight: 500;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b048dc13-185d-420d-8050-0e73ebaea54b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b048dc13-185d-420d-8050-0e73ebaea54b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b048dc13-185d-420d-8050-0e73ebaea54b';
